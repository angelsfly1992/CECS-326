...
//Sender Types, Change values according to the Program
#define SENDER_TYPE1 251
#define SENDER_TYPE2 997
#define SENDER_TYPE3 257

//Type of Events Data event (based on Division by Marker), Acknowledgement , Send Signal to receivers when terminated
...
struct buf {
	int    mtype; //Type of Message Data/Ack/Terminate message
	int data;
};
